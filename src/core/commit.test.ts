...
describe('Commit', () => {
  ...
  it('should throw if commit details are matched without capture groups', () => {
    const originalMatch = String.prototype.match
    const matchSpy = jest.spyOn(String.prototype, 'match')

    matchSpy.mockImplementation(function (
      this: string,
      ...
      if (
        ...
        pattern.source.includes('(?<type>[\\w ]*)')
      ) {
    ...
    expect(
      ...
      `"Error while parsing commit details."`
    )
